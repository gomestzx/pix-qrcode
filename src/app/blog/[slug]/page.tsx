...
export default async function PostPage({ params }: PostProps) {
  ...
  return (
      <div className="w-full md:w-4/6 mx-auto px-4 lg:px-0 max-w-4xl">
        <h1 className=" text-4xl lg:text-5xl font-darkerGrotesque font-extrabold">
          {post.fields.title}
        </h1>
        <p className=" text-lg lg:text-2xl mb-4 mt-6 border-b border-b-gray-200 pb-6">
          {post.fields.subtitle}
        </p>
        <div className=" flex w-full flex-wrap lg:flex-nowrap">
          <div className=" w-full lg:w-[65%] ">
            <div className="prose prose-lg font-nunito leading-6 text-lg">
